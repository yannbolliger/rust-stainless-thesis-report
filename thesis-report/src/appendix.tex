...
\lstinputlisting[
  language=Scala,
  caption={
    Final encoding of the \lstinline!sorted_insert! method from
    \autoref{lst:insertion-sort} in fully functional Stainless AST form that
    results after all Stainless transformations have passed. This is submitted
    to Inox.
  },
  label={apx:insertion-encoding},
  captionpos=t!
]{code/sorted_insert_2.scala}
\hspace{5mm}
