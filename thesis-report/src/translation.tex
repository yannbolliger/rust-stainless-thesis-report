...
other hand, the motivation of Stainless's aliasing restrictions is to
...
and for function arguments. To work around Stainless's aliasing restrictions we
...
that do not need to comply with Stainless's aliasing restrictions.
...
Consider \autoref{lst:tuple-sharing}, the introduced sharing
...
\lstinline!copy! are used to emit code that complies with Stainless's aliasing
...
Note that the Scala code of \autoref{lst:nested-cell} runs correctly in Scala,
