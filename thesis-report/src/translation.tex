...
implements this for primitive types (numeric types cf. \autoref{lst:copy},
...
translation presented in \autoref{translation} will extensively exploit this fact.
...
introduce a special wrapper case class, the mutable cell:
