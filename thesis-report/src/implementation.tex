...
is generated. LLVM is a general purpose compiler backend, also used by
C\texttt{++}. It will perform much more performance optimisations and finally
...
constants, and invariants on ADTs, known in Stainless.
