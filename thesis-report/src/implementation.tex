...
project.\footnote{\url{https://github.com/epfl-lara/rust-stainless/}} It
contains approximately 12K lines of Rust code and over 70 files or 3K lines Rust
code test examples. Most features described here are available on the
